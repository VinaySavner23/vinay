...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/schedule")]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpDelete]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/schedule/{schedule_id}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpDelete]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/schedule/{schedule_id}/timeslot/{key}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpGet]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/schedules")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpPatch]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/schedule/{schedule_id}/timezone")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpPost]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/schedule/{schedule_id}/timeslot")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
