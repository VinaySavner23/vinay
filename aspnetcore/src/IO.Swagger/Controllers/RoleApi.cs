...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/role")]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpDelete]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/role/{key}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpDelete]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/role/{key}/resource/{resource_id}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpGet]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/roles")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpPatch]
        [Route("/VinaySavner23/Nyo_Store/1.0.0-oas3/store/{store_id}/role/{key}/description")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
