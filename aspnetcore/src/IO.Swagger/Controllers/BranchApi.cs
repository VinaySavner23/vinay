...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/Developmenttest/NyoStore/2.1/store/{store_id}/branch")]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpDelete]
        [Route("/Developmenttest/NyoStore/2.1/store/{store_id}/branch/{key}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpDelete]
        [Route("/Developmenttest/NyoStore/2.1/store/{store_id}/branch/{key}/schedule/{schedule_id}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpPost]
        [Route("/Developmenttest/NyoStore/2.1/address-branches")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpGet]
        [Route("/Developmenttest/NyoStore/2.1/store/{store_id}/branches")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpPatch]
        [Route("/Developmenttest/NyoStore/2.1/store/{store_id}/branch/{key}/address/{address_id}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpPatch]
        [Route("/Developmenttest/NyoStore/2.1/store/{store_id}/branch/{key}/branch_id")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpPatch]
        [Route("/Developmenttest/NyoStore/2.1/store/{store_id}/branch/{key}/name")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        ...
        /// <response code="5XX">Unexpected Error</response>
        [HttpPatch]
        [Route("/Developmenttest/NyoStore/2.1/store/{store_id}/branch/{key}/status")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
